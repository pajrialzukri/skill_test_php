		...
		<div class="container pt-5 pb-3" >
			<div class="row">
				<div class="col-8">
					...
					<p>Berikut merupakan list pesanan yang sudah dilakukan </p>
				</div>
				<div class="col-2">
					<a href="beranda.php" class="btn btn-light">Lakukan Pemesanan</a>
				</div>
				<div class="col-2">
            ...
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $r_order['kode_transaksi'];?></td>
